...
<div class="row">
        ...
        <?php else : ?>
                <?php if (is_search()) : ?>
                    <div class="alert alert-danger" role="alert">
                        <p><?php _e('N&atilde;o foram encontrados Editais na categoria <?php single_term_title(); ?> com os termos buscados.'); ?></p>
                    </div>
                <?php else : ?>
                    <div class="alert alert-warning" role="alert">
                        <p><strong>Aguarde!</strong>&nbsp;<?php _e('N&atilde;o h&aacute; Editais publicados na categoria <?php single_term_title(); ?>.'); ?></p>
                    </div>
                <?php endif; ?>
        <?php endif; ?>
    </div>
    <div class="col-xs-12 col-md-3">
        <aside>
            ...
            <br>
            <a href="<?php echo get_post_type_archive_link( 'edital' ); ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Todos os Editais</a>
        </aside>
    </div>
</div>
