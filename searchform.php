<form role="search" method="get" class="form-inline searchform" action="<?php echo esc_url(home_url('/')); ?>">
    ...
    <div class="input-group">
        ...
        <span class="input-group-append">
            <button type="submit" class="btn btn-secondary searchform__submit" title="Buscar em todo o Portal" value="Buscar"><i class="fas fa-search" aria-hidden="true"></i></button>
        </span>
    </div>
</form>
