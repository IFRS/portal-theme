<div class="row">
    <div class="col-xs-12">
        ...
        <?php if (has_post_thumbnail()) : ?>
            <?php the_post_thumbnail('post-thumbnail', array('class' => 'img-responsive center-block noticia__img')); ?>
        <?php else : ?>
            <img src="<?php echo get_template_directory_uri(); ?>/img/noticia-placeholder-<?php echo mt_rand(0, 9); ?>.png" alt="<?php the_title(); ?>" class="img-responsive center-block noticia__img"/>
        <?php endif; ?>
        </a>
