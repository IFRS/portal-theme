<a href="<?php the_permalink(); ?>" class="noticia__link">
    <div class="noticia__img-wrapper">
        ...
        <?php else : ?>
            <img data-src="<?php echo esc_url(get_template_directory_uri()); ?>/img/noticia-placeholder.jpg" alt="<?php the_title(); ?>" class="lazyload img-fluid noticia__img" loading="lazy" width="720" height="540" aria-hidden="true"/>
        <?php endif; ?>
    </div>
