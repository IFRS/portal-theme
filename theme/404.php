...
<main class="container">
  ...
  <figure class="wp-block-image aligncenter size-full img-fluid"><img src="<?php echo esc_url( get_parent_theme_file_uri( '/img/404.png' ) ); ?>" alt="Erro 404 - Página não encontrada" loading="eager" /></figure>
  <!-- /wp:image -->
