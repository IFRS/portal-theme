...
<?php if (count($children) > 0) : ?>
  ...
  <?php if ($parent) : ?>
    <li class="nav-item nav-item--parent">
      <a class="nav-link" href="<?php echo esc_url(get_page_link($parent)); ?>">
  ...
  <?php foreach ($children as $child): ?>
    <li class="nav-item">
      <a class="nav-link" href="<?php echo esc_url(get_page_link($child->ID)); ?>"><?php echo esc_html($child->post_title); ?></a>
    </li>
  <?php endforeach; ?>
  </ul>
<?php endif; ?>
