...
<nav class="menu-campi navbar navbar-expand-md bg-body-tertiary">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler mx-auto collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#<?php echo esc_attr($id); ?>" aria-expanded="false" aria-controls="<?php echo esc_attr($id); ?>" aria-label="<?php esc_attr_e('Alternar lista de campi', 'ifrs-portal-theme'); ?>">
