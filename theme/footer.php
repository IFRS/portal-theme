...
<footer>
  ...
  <section class="footer__creditos">
    <svg style="display: none;">
      ...
      <symbol id="arrow-up-right-from-square" viewBox="0 0 640 640">
    ...
    <a href="https://br.wordpress.org/" target="_blank" rel="noopener" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php esc_attr_e('Desenvolvido com WordPress', 'ifrs-portal-theme'); ?>">
      ...
      <svg height="14" width="14" fill="currentColor" class="ms-1" aria-hidden="true" focusable="false">
  ...
  <button type="button" class="footer__back-to-top btn rounded-circle" tabindex="-1" aria-label="<?php esc_attr_e('Voltar ao topo da página', 'ifrs-portal-theme'); ?>">
    <span class="visually-hidden"><?php esc_html_e('Voltar ao topo', 'ifrs-portal-theme'); ?></span>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M169.4 137.4c12.5-12.5 32.8-12.5 45.3 0l160 160c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L192 205.3 54.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160z"/></svg>
  </button>
</footer>
