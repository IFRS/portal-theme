...
function portal_widgets_init() {
	...
	register_sidebar(array(
		...
		'before_widget' => '<div class="row"><div class="col-xs-12"><div id="%1$s" class="area-home__widget %2$s">',
	...
	register_sidebar(array(
		...
		'before_widget' => '<div class="row"><div class="col-xs-12"><div id="%1$s" class="area-home-side__widget %2$s">',
		'after_widget'  => '</div></div></div>',
		'before_title'  => '<span class="sr-only">',
		'after_title'   => '</span>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div class="row"><div class="col-xs-12"><div id="%1$s" class="area-docs__widget %2$s">',
		'after_widget'  => '</div></div></div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div class="row"><div class="col-xs-12"><div id="%1$s" class="area-gallery__widget %2$s">',
		'after_widget'  => '</div></div></div>',
	...
	register_sidebar(array(
		...
		'before_widget' => '<div class="row"><div class="col-xs-12"><div id="%1$s" class="area-rodape__widget %2$s">',
		'after_widget'  => '</div></div></div>',
		'before_title'  => '<span class="sr-only">',
		'after_title'   => '</span>',
	));
